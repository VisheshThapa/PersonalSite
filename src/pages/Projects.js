 ...
 variants = {pageVariants} transition = {pageTransition}>
  ...
  <div class="leftcolumn">
    ...
    <div class="card">
      ...
      <p style = {{marginTop:"10px"}}>This is a random workout generator which was created in Python with the use of tkinter library. The python application works by reading a txt file which contains the exercise list and creates a workout based on the inputs the user gives. The user can pick the body part, the number of sets and number of exercises per body part. Currently, the greatest limitation of this application is that it can only access the exercises that are in the txt file. I would like to improve it further by the use of the BeautifulSoup library allowing the application to acces online resources to gain a multitudes to exercise that the application can use.</p>
